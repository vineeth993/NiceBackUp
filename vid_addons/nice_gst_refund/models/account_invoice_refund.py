    ...
    def compute_refund(self, cr, uid, ids, mode='refund', context=None):
        ...
        for form in self.browse(cr, uid, ids, context=context):
            ...
            for inv in inv_obj.browse(cr, uid, context.get('active_ids'), context=context):
                ...
                context.update({
                    'gst_refund_type': form.gst_refund_type or None,
                    'refund_reason_id': form.refund_reason_id or None,
                    'extra_discount_amount':inv.extra_discount_amount or 0.00,
                    'partner_selling_type':inv.partner_selling_type or None,
                    'partner_selling_type_id':inv.partner_selling_type_id or None,
                    'extra_discount':inv.extra_discount or 0.00,
                    'additional_extra_disocunt':inv.additional_extra_disocunt or 0.00,
                    })
